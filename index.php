...
<body>
    ...
    <nav id="menu">
        ...
        <ul>
            ...
            <li><a href="inserirlivros.php">Inserir livros</a></li>
        </ul>
    </nav> -->
            ...
            <tbody id="teste">
                <?php 
                    foreach($array as $a){
                        ...
                        print "<td><button class=\"btn btn-success\"  onclick=\"enviarpagina($a->id)\" type=\"submit\">Resumo</button><button  class=\"btn btn-danger\" type=\"submit\">Apagar</button><button  class=\"btn btn-warning\" type=\"submit\">Alterar</button></td>";
                        print "</tr>";
                    }
                ?>
